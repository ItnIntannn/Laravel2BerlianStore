...
<body class="hold-transition login-page" style="background-image: url(BackgroundLogin.jpg)">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-danger" >
    <div class="card-header text-center" >
      <img class="logo" src="/BerlianPink.png" alt="Logo" style="height: 250px; width: 250px;" >
    </div>
